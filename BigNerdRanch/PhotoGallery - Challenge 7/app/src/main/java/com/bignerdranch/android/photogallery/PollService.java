...
public class PollService extends IntentService {
    ...
    public static boolean inServiceAlarmOn(Context context) {
        Intent i = PollService.newIntent(context);
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        ...
        if (firstItemId.equals(lastResultId)) {
            Log.i(TAG, "Stary wynik wyszukiwania: " + firstItemId);
        } else {
            Log.i(TAG, "Nowy wynik wyszukiwania: " + firstItemId);
            Resources resources = getResources();
            Intent i = PhotoGalleryActivity.newIntent(this);
            PendingIntent pi = PendingIntent.getActivity(this, 0, i, 0);
            Notification notification = new NotificationCompat.Builder(this)
                    .setTicker(resources.getString(R.string.new_picture_title))  //tekst powiadomienia
        ...
        QueryPreferences.setLastResultId(this, firstItemId);
