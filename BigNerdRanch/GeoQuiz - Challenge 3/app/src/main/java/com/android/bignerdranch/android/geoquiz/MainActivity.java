...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // mAPINumberTextView.setTypeface(Typeface.DEFAULT);

        mAPINumberTextView.setText(String.format("API Level %d", Build.VERSION.SDK_INT ) );
        ...
        mCheatButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivityForResult(CheatActivity.newIntent(MainActivity.this, answerIsTrue,answers.values()), REQUEST_CODE_CHEAT);
            }
        });
